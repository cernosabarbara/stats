...
# KONCNI POPRAVKI
# TESTS FOR MULTICOLINEARITY, HETEROSCEDAcITY, RESIDUALS
# top 6 checks
...
# The distribution of the residuals looks more t shaped for top 6 and skewed right for 'all countries'. I will therefore transform them.
#  address the the residual non-normality issues with a Box-Cox conversion (tried logaghirthmic as well)
